...
def create_schedule(subjects, teachers):
    ...
    while remaining_subjects:
        ...
        for teacher in teachers:
            ...
            if len(teachable_subjects) > best_coverage or (
                len(teachable_subjects) == best_coverage and best_teacher and teacher.age < best_teacher.age
            ):
                best_teacher = teacher
                best_coverage = len(teachable_subjects)
